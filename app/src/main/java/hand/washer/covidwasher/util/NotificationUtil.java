...
import hand.washer.covidwasher.AppConstants;
import hand.washer.covidwasher.MainActivity;
import hand.washer.covidwasher.R;
import hand.washer.covidwasher.TimerNotification;
...
public class NotificationUtil {
    ...
    public static void showTimerExpired(Context context){
        Intent startIntent = new Intent(context, TimerNotification.class);
    ...
    public static void showTimerRunning(Context context, Long wakeUpTime){
        Intent stopIntent = new Intent(context, TimerNotification.class);
        stopIntent.setAction(AppConstants.ACTION_STOP);
        PendingIntent stopPendingIntent = PendingIntent.getBroadcast(context, 0,
                stopIntent,PendingIntent.FLAG_UPDATE_CURRENT);

        Intent pauseIntent = new Intent(context, TimerNotification.class);
    ...
    public static void showTimerPaused(Context context){
        Intent resumeIntent = new Intent(context, TimerNotification.class);
